if (function() {
    ...
    var n, q, s, t, u, v, b = "Close", c = "BeforeClose", d = "AfterClose", e = "BeforeAppend", f = "MarkupParse", g = "Open", h = "Change", i = "mfp", j = "." + i, k = "mfp-ready", l = "mfp-removing", m = "mfp-prevent-close", o = function() {}, p = !!window.jQuery, r = a(window), w = function(a, b) {
        n.ev.on(i + a + j, b);
    }, x = function(b, c, d, e) {
    ...
    o.prototype = {
        ...
        open: function(b) {
            ...
            n.fixedContentPos ? n.wrap.css({
                ...
                top: r.scrollTop(),
                position: "absolute"
            }), (n.st.fixedBgPos === !1 || "auto" === n.st.fixedBgPos && !n.fixedContentPos) && n.bgOverlay.css({
                height: s.height(),
                position: "absolute"
        ...
        _close: function() {
            ...
            s.off("keyup" + j + " focusin" + j), n.ev.off(j), n.wrap.attr("class", "mfp-wrap").removeAttr("style"), 
            ...
            n.content = null, n.currTemplate = null, n.prevHeight = 0, y(d);
        },
        ...
        appendContent: function(a, b) {
            n.content = a, a ? n.st.showCloseBtn && n.st.closeBtnInside && n.currTemplate[b] === !0 ? n.content.find(".mfp-close").length || n.content.append(z()) : n.content = a : n.content = "", 
            y(e), n.container.addClass("mfp-" + b + "-holder"), n.contentContainer.append(n.content);
        },
        parseEl: function(b) {
            var d, c = n.items[b];
            if (c.tagName ? c = {
        ...
        _openClick: function(b, c, d) {
            var e = void 0 !== d.midClick ? d.midClick : a.magnificPopup.defaults.midClick;
            if (e || !(2 === b.which || b.ctrlKey || b.metaKey || b.altKey || b.shiftKey)) {
            ...
            findImageSize: function(a) {
                var b = 0, c = a.img[0], d = function(e) {
                    L && clearInterval(L), L = setInterval(function() {
                        return c.naturalWidth > 0 ? void n._onImageHasSize(a) : (b > 200 && clearInterval(L), 
                        b++, 3 === b ? d(10) : 40 === b ? d(50) : 100 === b && d(500), void 0);
                    }, e);
                };
                d(1);
            },
                    ...
                    w("BuildControls" + d, function() {
                        ...
                        if (n._allowZoom()) {
                            if (clearTimeout(i), n.st.removalDelay = f, !e) {
                                if (e = n._getItemToZoom(), !e) return;
                                j = g(e);
                            }
    ...
    a.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                return n.direction = !0, !(!c || !c.enabled) && (u += " mfp-gallery", w(g + d, function() {
